...
<img src="/docs/img/sdr-history2" height="95%" width="95%" />

## The name
A name was selected at that time: System Data Recorder (SDR)

"SystemDataRecorder is simple to use for performance analysis, system sizing, and capacity planning in today's challenging business environments. Keep it simple: record server or application data, store it for long periods of time and analyze it.
